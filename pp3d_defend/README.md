...
This is the Firefox mobile implementation of the PP_Defend browser extension. For complete project documentation, see the [main PP_Defend README](../pp_defend/README.md) and [PixelPatrol3D project overview](../README.md).
